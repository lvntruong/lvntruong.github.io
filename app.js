const messages = {
  en: {
    ...
    work: {
      ...
      clascity: {
        title: 'Clascity',
        bodyHTML: '<p>Search and connect with tutors from across the web. In just a few clicks, you will be learning from the best teachers and gurus out there.</p>'
      },
    },
    about: {
      title: 'About',
...
new Vue({
  ...
  data () {
    return {
      ...
      testimonials: [
        {
          body: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eget tortor sit amet augue imperdiet placerat. Sed vulputate consequat nulla et sollicitudin. Vivamus vel enim eu justo congue sollicitudin ac sed risus. Curabitur a orci vel ipsum ultricies rhoncus auctor sed sem. Curabitur vel accumsan lacus. ',
